...
# version 1.5: Select volumes for snapshotting depending
#              on Tag and not from config file
...
# version 3.1: Fix a bug with the deletelist and added
#             a pause in the volume loop
...
# v0.1 : Improvisations for pep8 compatilbility

# Removed latter half of the script to test additional functionalities
# This script will eventually function as a dry run version
import boto
...
for vol in vols:
	...
	#print  vol.id, vol.attach_data.instance_id
...
#-----------------------------------------------
# Uncomment the section below for re-activating
#----------------------------------------------
